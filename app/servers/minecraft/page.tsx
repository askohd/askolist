...
export const metadata: Metadata = {
  title: "Minecraft Discord Server finden – Deutsche Minecraft Communities",
  description:
    "Finde Minecraft Discord Server für deutsche und internationale Minecraft Communities. Entdecke Server für Survival, SMP, Citybuild, Events und neue Mitspieler.",
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Minecraft Discord Server finden",
      },
    ],
  },
  twitter: {
...
async function getServers() {
  const servers = await supabaseRequest(
    "servers?approved=eq.true&status=eq.approved&or=(category.ilike.*Minecraft*,tags.cs.{minecraft},description.ilike.*Minecraft*,server_name.ilike.*Minecraft*)&select=*&limit=60"
  );
    ...
    <main className="container servers-directory-page">
      <section className="servers-directory-header">
        <div>
          ...
          <h1>Minecraft Discord Server</h1>
          <p>Finde Minecraft Discord Server für Survival, SMP, Citybuild, Events, neue Mitspieler und deutsche Minecraft Communities.</p>
        </div>
