...
export const metadata: Metadata = {
  title: "Gaming Discord Server finden – Deutsche Gaming Communities",
  description:
    "Finde aktive Gaming Discord Server für deutsche und internationale Communities. Entdecke Server für Zocken, Voicechat, Events, Minecraft, Valorant und mehr.",
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Gaming Discord Server finden",
      },
    ],
  },
  twitter: {
...
async function getServers() {
  const servers = await supabaseRequest(
    "servers?approved=eq.true&status=eq.approved&category=eq.Gaming&select=*&limit=60"
  );
    ...
    <main className="container servers-directory-page">
      <section className="servers-directory-header">
        <div>
          ...
          <h1>Gaming Discord Server</h1>
          <p>Entdecke Gaming Discord Server auf Asko Cafe. Finde Communities zum Zocken, Chatten, Events planen und neue Mitspieler kennenlernen.</p>
        </div>
