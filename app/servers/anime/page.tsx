...
export const metadata: Metadata = {
  title: "Anime Discord Server finden – Anime Communities",
  description:
    "Entdecke Anime Discord Server und Communities für deutsche und internationale Anime-Fans. Finde neue Anime Server, Manga Communities und Chill Server.",
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Anime Discord Server finden",
      },
    ],
  },
  twitter: {
...
async function getServers() {
  const servers = await supabaseRequest(
    "servers?approved=eq.true&status=eq.approved&category=eq.Anime&select=*&limit=60"
  );
    ...
    <main className="container servers-directory-page">
      <section className="servers-directory-header">
        <div>
          ...
          <h1>Anime Discord Server</h1>
          <p>Finde Anime Discord Server für Anime-Fans, Manga, Cosplay, Community, Watchpartys und neue Kontakte.</p>
        </div>
