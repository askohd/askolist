...
export const metadata: Metadata = {
  title: "Valorant Discord Server finden – Deutsche Valorant Communities",
  description:
    "Finde Valorant Discord Server für deutsche und internationale Valorant Communities. Entdecke Server für Ranked, Teamsuche, Scrims, Events und neue Mitspieler.",
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Valorant Discord Server finden",
      },
    ],
  },
  twitter: {
...
async function getServers() {
  const servers = await supabaseRequest(
    "servers?approved=eq.true&status=eq.approved&or=(category.ilike.*Valorant*,tags.cs.{valorant},description.ilike.*Valorant*,server_name.ilike.*Valorant*)&select=*&limit=60"
  );
    ...
    <main className="container servers-directory-page">
      <section className="servers-directory-header">
        <div>
          ...
          <h1>Valorant Discord Server</h1>
          <p>Entdecke Valorant Discord Server für Ranked, Teamsuche, Scrims, Events, Gaming und deutsche Valorant Communities.</p>
        </div>
