...
export const metadata: Metadata = {
  ...
  description:
    "Entdecke aktive deutsche Discord Server für Gaming, Anime, Community, Chill, Minecraft, Valorant, Events und mehr. Finde neue deutsche Communities oder trage deinen eigenen Discord Server kostenlos ein.",
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Deutsche Discord Server finden",
      },
    ],
  },
  twitter: {
...
async function getServers() {
  const servers = await supabaseRequest(
    "servers?approved=eq.true&status=eq.approved&language=eq.Deutsch&select=*&limit=60"
  );
    ...
    <main className="container servers-directory-page">
      <section className="servers-directory-header">
        <div>
          ...
          <h1>Deutsche Discord Server</h1>
          <p>Finde aktive deutsche Discord Server und Communities auf Asko Cafe. Entdecke Gaming Server, Anime Server, Minecraft Server, Valorant Server, Chill Server und neue deutsche Discord Communities.</p>
        </div>
