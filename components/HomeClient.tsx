...
const SEO_TEXT = {
  de: {
    ...
    animeServers: "Anime Discord Server",
    minecraftServers: "Minecraft Discord Server",
    valorantServers: "Valorant Discord Server",
    communityServers: "Community Discord Server",
    submitServer: "Discord Server eintragen",
  },
  en: {
    title: "Discord server list for active communities",
    intro:
      "Asko Cafe is a Discord server list for active German and international communities. Find new Discord servers for gaming, anime, Minecraft, Valorant, community, friendships and support or submit your own server for free.",
    categoriesTitle: "Popular Discord server categories",
    categoriesText:
      "Browse topic-based server lists and find fitting communities faster through our category pages.",
    whyTitle: "Why use Asko Cafe for Discord servers?",
    whyText:
      "Our server list shows approved Discord servers with categories, language, bumps, premium labels and current community data. This helps users discover active servers and helps server owners build reach.",
    submitTitle: "Submit your own Discord server",
    submitText:
      "Running a Discord server? Submit it on Asko Cafe, invite the bot and use bumps to make your community more visible.",
    allServers: "Discord Server List",
    germanServers: "German Discord Servers",
    gamingServers: "Gaming Discord Servers",
    animeServers: "Anime Discord Servers",
    minecraftServers: "Minecraft Discord Servers",
    valorantServers: "Valorant Discord Servers",
    communityServers: "Community Discord Servers",
    submitServer: "Submit Discord Server",
  },
  fr: {
    title: "Liste de serveurs Discord pour communautés actives",
    intro:
      "Asko Cafe est une liste de serveurs Discord pour communautés allemandes et internationales actives. Trouve des serveurs Discord gaming, anime, Minecraft, Valorant, community, amitié et support ou ajoute gratuitement ton propre serveur.",
    categoriesTitle: "Catégories populaires de serveurs Discord",
    categoriesText:
      "Parcours les listes thématiques et trouve plus vite des communautés adaptées grâce aux pages de catégories.",
    whyTitle: "Pourquoi utiliser Asko Cafe pour les serveurs Discord ?",
    whyText:
      "Notre liste affiche des serveurs Discord approuvés avec catégories, langue, bumps, labels premium et données communautaires actuelles.",
    submitTitle: "Ajouter ton propre serveur Discord",
    submitText:
      "Tu gères un serveur Discord ? Ajoute-le sur Asko Cafe, invite le bot et utilise les bumps pour rendre ta communauté plus visible.",
    allServers: "Liste des serveurs Discord",
    germanServers: "Serveurs Discord allemands",
    gamingServers: "Serveurs Discord gaming",
    animeServers: "Serveurs Discord anime",
    minecraftServers: "Serveurs Discord Minecraft",
    valorantServers: "Serveurs Discord Valorant",
    communityServers: "Serveurs Discord community",
    submitServer: "Ajouter un serveur Discord",
  },
  it: {
    title: "Lista server Discord per community attive",
    intro:
      "Asko Cafe è una lista di server Discord per community tedesche e internazionali attive. Trova server Discord gaming, anime, Minecraft, Valorant, community, amicizie e supporto oppure aggiungi gratis il tuo server.",
    categoriesTitle: "Categorie popolari di server Discord",
    categoriesText:
      "Sfoglia liste tematiche e trova più velocemente community adatte tramite le pagine categoria.",
    whyTitle: "Perché usare Asko Cafe per i server Discord?",
    whyText:
      "La nostra lista mostra server Discord approvati con categorie, lingua, bump, badge premium e dati community aggiornati.",
    submitTitle: "Aggiungi il tuo server Discord",
    submitText:
      "Gestisci un server Discord? Aggiungilo su Asko Cafe, invita il bot e usa i bump per rendere la community più visibile.",
    allServers: "Lista server Discord",
    germanServers: "Server Discord tedeschi",
    gamingServers: "Server Discord gaming",
    animeServers: "Server Discord anime",
    minecraftServers: "Server Discord Minecraft",
    valorantServers: "Server Discord Valorant",
    communityServers: "Server Discord community",
    submitServer: "Aggiungi server Discord",
  },
  pl: {
    title: "Lista serwerów Discord dla aktywnych społeczności",
    intro:
      "Asko Cafe to lista serwerów Discord dla aktywnych społeczności niemieckich i międzynarodowych. Znajdź serwery Discord gaming, anime, Minecraft, Valorant, community, znajomych i support albo dodaj własny serwer za darmo.",
    categoriesTitle: "Popularne kategorie serwerów Discord",
    categoriesText:
      "Przeglądaj tematyczne listy serwerów i szybciej znajduj pasujące społeczności przez strony kategorii.",
    whyTitle: "Dlaczego Asko Cafe dla serwerów Discord?",
    whyText:
      "Nasza lista pokazuje zatwierdzone serwery Discord z kategoriami, językiem, bumpami, oznaczeniami premium i aktualnymi danymi społeczności.",
    submitTitle: "Dodaj własny serwer Discord",
    submitText:
      "Prowadzisz serwer Discord? Dodaj go do Asko Cafe, zaproś bota i używaj bumpów, aby zwiększyć widoczność społeczności.",
    allServers: "Lista serwerów Discord",
    germanServers: "Niemieckie serwery Discord",
    gamingServers: "Serwery Discord gaming",
    animeServers: "Serwery Discord anime",
    minecraftServers: "Serwery Discord Minecraft",
    valorantServers: "Serwery Discord Valorant",
    communityServers: "Serwery Discord community",
    submitServer: "Dodaj serwer Discord",
  },
} as const;

const SEO_CATEGORY_LINKS = [
  { href: "/servers", key: "allServers" },
  { href: "/servers/deutsch", key: "germanServers" },
  { href: "/servers/gaming", key: "gamingServers" },
  { href: "/servers/anime", key: "animeServers" },
  { href: "/servers/minecraft", key: "minecraftServers" },
...
function st(language: UiLanguage, key: keyof typeof SEO_TEXT.de) {
  return SEO_TEXT[language]?.[key] || SEO_TEXT.de[key];
}
...
type HomeClientProps = {
  initialPremiumServers?: Server[];
  initialOverviewServers?: Server[];
};

export default function HomeClient({
  initialPremiumServers = [],
  initialOverviewServers = [],
}: HomeClientProps) {
  const language = useLanguage() as UiLanguage;

  const [premiumServers, setPremiumServers] =
    useState<Server[]>(initialPremiumServers);
  const [overviewServers, setOverviewServers] =
    useState<Server[]>(initialOverviewServers);
  ...
  return (
    ...
    >
      <style>{`
        ...
        .home-seo-card {
          ...
          background:
            ...
            linear-gradient(180deg, rgba(21, 17, 44, 0.82), rgba(14, 15, 34, 0.88));
          border: 1px solid rgba(167, 114, 255, 0.26);
          box-shadow:
            0 0 0 1px rgba(255, 255, 255, 0.035) inset,
        ...
        .home-seo-links a {
          ...
          border: 1px solid rgba(255, 255, 255, 0.13);
          box-shadow: 0 0 18px rgba(116, 223, 255, 0.08);
        }

        .home-seo-links a:hover {
          background: linear-gradient(135deg, rgba(181, 76, 255, 0.48), rgba(116, 223, 255, 0.28));
      ...
      <section className="home-seo-section" aria-labelledby="discord-server-list-seo">
        <div className="home-seo-card">
          <h2 id="discord-server-list-seo">{st(language, "title")}</h2>
          <p>{st(language, "intro")}</p>

          <h3>{st(language, "categoriesTitle")}</h3>
          <p>{st(language, "categoriesText")}</p>

          <div className="home-seo-links">
            {SEO_CATEGORY_LINKS.map((item) => (
              <Link key={item.href} href={item.href}>
                {st(language, item.key as keyof typeof SEO_TEXT.de)}
              </Link>
            ))}
          </div>

          <h3>{st(language, "whyTitle")}</h3>
          <p>{st(language, "whyText")}</p>

          <h3>{st(language, "submitTitle")}</h3>
          <p>{st(language, "submitText")}</p>
        </div>
      </section>
    </main>
  );
